...
$_['text_success']                   = 'Sådan! Ændringerne til dine CoolPay-indstillinger er blevet gemt.';
$_['text_edit']                      = 'Rediger CoolPay';
$_['text_CoolPay']                  = '<a target="_blank" href="https://CoolPay.net"><img style="height: 30px;" src="view/image/extension/payment/logo.png" alt="CoolPay" title="CoolPay" style="border: 1px solid #EEEEEE;" /></a>';
...
$_['help_CoolPay_setup']      = '<a target="_blank" href="https://learn.CoolPay.net/helpdesk/en/articles/integrations/opencart/">Klik her</a> for at lære hvordan du opsætter din CoolPay-konto.';
...
$_['help_text_on_statement']   = 'Tekst der skal vises på kortholders kontooversigt. Max 22 ASCII karakterer. Supporteres i øjeblikket kun af CoolPay.';
...
$_['help_order_number_prefix'] = 'Indtast en streng, hvis du ønsker at prefixe det ordrenummer, der sendes til CoolPay. Dette har ikke effekt på ordrenumrene i butikken.';
$_['tab_setting']              = 'Indstillinger';
$_['tab_recurring']            = 'Abonnementer';


// Error
$_['error_permission']      = 'Advarsel: Du har ikke rettigheder til at administrere CoolPay!';
