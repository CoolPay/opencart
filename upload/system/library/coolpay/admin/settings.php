...
namespace CoolPay\Admin;

/**
 * Trait Settings
 *
 * @package CoolPay\Admin
 */
trait Settings {
	...
	public function index() {
		...
		$this->load->language( 'extension/payment/coolpay' );
		...
		$this->data['section'] = [
			'api'     => $this->load->view( 'extension/payment/coolpay/settings/api', $this->data ),
			'gateway' => $this->load->view( 'extension/payment/coolpay/settings/gateway', $this->data ),
			'others'  => $this->load->view( 'extension/payment/coolpay/settings/others', $this->data ),
		];
