...
trait Controller {
	...
	public function index() {
		...
		return $this->load->view( 'extension/payment/coolpay', [] );
	}
	...
	/**
	 * @return Model
	 * @return \CoolPay\Catalog\Recurring\Model
	 */
	...
	/**
	 * Route: Handles the callback from CoolPay
	 */
	...
	protected function isAuthorizedCallback( $response_body ) {
		...
		return hash_hmac( 'sha256', $response_body, $this->instanceConfig( 'private_key' ) ) == $_SERVER["HTTP_COOLPAY_CHECKSUM_SHA256"];
	}
